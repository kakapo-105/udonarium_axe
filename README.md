...
| MCP による AI 操作            | Claude Code などの AI から MCP 経由で、部屋・コマの確認、コマの移動、チャット送信ができる。[okamichi さんの feat/mcp](https://github.com/okamichi/udonarium_axe/tree/feat/mcp) を 1.57.1 向けに移植したもの | [MCP の導入手順](tools/mcp-server/README.md)                             |
